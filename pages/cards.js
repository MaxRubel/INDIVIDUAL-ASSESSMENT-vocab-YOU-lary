...
const showCards = (array) => {
  ...
  const btnString = '<button class="btn btn-success btn-lg mb-4" id="addACard">Add A Card</button> <button class="btn btn-success btn-lg mb-4" id="addALanguage">Add A Language</button>';
